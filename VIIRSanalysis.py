...
print(AllBands[y][len(AllBands[y])-1,0]+10)
...
# plt.xlabel('Wavelength (nm)')
# plt.ylabel('Intensity')
# plt.title('VIIRS bands with scaling')
plt.plot(wavelength, avgPixel3, label = 'Img Data')
plt.plot(AllBands[0][:,0], AllBands[0][:,1], label='M1')
plt.plot(AllBands[1][:,0], AllBands[1][:,1], label='M2')
plt.plot(AllBands[2][:,0], AllBands[2][:,1], label='M3')
plt.plot(AllBands[3][:,0], AllBands[3][:,1], label='M4')
plt.plot(AllBands[4][:,0], AllBands[4][:,1], label='M5')
plt.plot(AllBands[5][:,0], AllBands[5][:,1], label='M6')
plt.plot(AllBands[6][:,0], AllBands[6][:,1], label='M7')
plt.plot(AllBands[7][:,0], AllBands[7][:,1], label='I1')
plt.plot(AllBands[8][:,0], AllBands[8][:,1], label='I2')
plt.show()
plt.close()

# plt.xlabel('Wavelength (nm)')
# plt.ylabel('Intensity')
# plt.title('Example Data limited to VIIRS bands')
